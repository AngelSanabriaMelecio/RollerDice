...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        boton.setOnClickListener {
            ...
            Toast.makeText(
                applicationContext,
                "Boton presionado aleatorios " + al + " y " + al2,
                Toast.LENGTH_LONG
            ).show()

            img.setImageResource(idImagenAl(al))
            img2.setImageResource(idImagenAl(al2))

            lbl.text = al.toString() + " y " + al2.toString()
        }
    }
    ...
    private fun idImagenAl( al:Int ): Int {
        val id =when (al){
            1 -> R.drawable.dice_1
            2 -> R.drawable.dice_2
            3 -> R.drawable.dice_3
